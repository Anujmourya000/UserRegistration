...
public class UserValidation {
    ...
    @Test
    public void validate_The_User_For_FirstName_True_if_Correct(){
    ...
    @Test
    public void Validate_The_User_for_LastName_True_if_Correct(){
        UserValidate validate = new UserValidate();
    ...
    @Test
    public void Validate_The_User_For_Email_True_If_Correct(){
        UserValidate validate = new UserValidate();
    ...
    @Test
    public void Validate_The_User_For_Mobile_True_If_Correct(){
        UserValidate validate = new UserValidate();
    ...
    @Test
    public void Validate_The_User_For_Password_True_If_Correct(){
        UserValidate validate = new UserValidate();
